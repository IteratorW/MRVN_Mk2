...
@runtime.bot.slash_command(category=search_category, description=Translatable("search_command_yt_desc"))
async def yt(ctx: MrvnCommandContext, query: ParseUntilEndsOption(str)):
    await cse.search(ctx, query, SearchType.YOUTUBE)
